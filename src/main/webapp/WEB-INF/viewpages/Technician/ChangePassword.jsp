...
<div class="center">
<form name="form3" method="post" action="chngpassprocess" class="form-horizontal" >
...
<td><input type="text"   id="oldpass"  name="oldpass"  required/>
</td>
</tr>

<tr>
<td>New Password</td>
<td><input type="password"  name="newpass"   required/>
</td>
</tr>

<tr>
<td>Confirm Password</td>
<td><input type="password"  name="conpass"   required/>
</td>
</tr>
