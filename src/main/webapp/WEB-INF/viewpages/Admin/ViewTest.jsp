...
<a href="viewtest" >
<button class="btn-default btn-lg">View Tests</button>
</a>
</div>
...
<div class="box">
<div class="right-side">
<a href="viewtechnician" >
<button class="btn-default btn-lg">View Technician</button>
</a>
</div>
...
<div class="right-side">
<a href="viewrequest" >
<button class="btn-default btn-lg">View Requests</button>
</a>
</div>
</div>
...
<div class="right-side">
<a href="viewcustomer" >
<button class="btn-default btn-lg">View Customers</button>
</a>
</div>
</div>
<br><br><br><br>
...
<th scope="col">Test Taken Time</th>
</tr>
</thead>
<tbody>
<c:forEach var="tst" items="${tlist }">
<tr style="text-align:center">
<td>${tst.tname }</td>
<td>${tst.cost }</td>
<td>${tst.tType }</td>
