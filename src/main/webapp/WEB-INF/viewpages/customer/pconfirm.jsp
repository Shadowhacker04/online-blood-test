...
<body>
  ...
  <option value="URINE">
    ...
    <form onsubmit="return check();" action="bookpack" method="post" >
	...
	<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						<tr>
							...
							<td data-th="Price">₹ ${pcost}</td>
							<td data-th="Quantity">
								<input name="datep" type="date" id="datep" oninput="gen()" class="form-control text-center" required >
							</td>
							<td data-th="Subtotal" class="text-center">₹ ${pcost}</td>
							<td><input name="idealp" placeholder="Auto-generated" type="text" id="idealp" size="10" readonly/></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
...
function gen() {
	...
	for (var i = 0; i <= passwordLength; i++) {
	  ...
	  pass += chars.substring(randomNumber, randomNumber +1);
	       ...
	       document.getElementById("idealp").value = id;
	}
function check(){
var GivenDate = document.getElementById("datep").value;
