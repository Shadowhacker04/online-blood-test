...
<style>
html { 
  background: url(images/newest.jpg) no-repeat center center fixed; 
...
<header>
<h1 class="logo">DOCTORS' CHOICE PATHLAB</h1>
</header>
...
<div id="container">
  ...
  <form name="loginform" method="post" action="login">
    ...
    <input type="submit" value="Login" class="oa" />
   <p>
   <div class="row" >
   
    <a  href="cusreg" class="oa" >Register </a>
 
      <a href="forget" class="oa">Forgotten password</a>
