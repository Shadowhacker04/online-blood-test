					...
					<div class="resp-tabs-container">
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
							...
							<form action="getuid" method="post">
								<input type="text" Name="mobile" value="${phone}" readonly/>
								<input type="text" Name="qone" value="${qone}" readonly>
								<input type="text" Name="qtwo" value="${qtwo}" readonly>
								<input type="text" Name="qthree" value="${qthree}" readonly>
								<b><input type="text" value="${cusid}" readonly/></b>
